...
class ReturnHTMLPage(BaseModel):
    html: str
...
def get_cube_geometry():
    cube_jsx = """
      ...
      const sunMaterial = new THREE.MeshPhongMaterial({ color: 0xffcc00, emissive: 0xffaa00, emissiveIntensity: 0.5 });
