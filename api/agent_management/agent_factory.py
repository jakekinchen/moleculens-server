...
class AgentFactory:
    ...
    def create_all_agents(
        ...
        """
        agents = {
            AgentType.DOMAIN_VALIDATOR: AgentFactory.create_domain_validator(
                global_override_model
            ),
            AgentType.SCRIPT: AgentFactory.create_script_agent(global_override_model),
            AgentType.ORCHESTRATION: AgentFactory.create_orchestration_agent(
                global_override_model
            ),
            AgentType.GEOMETRY: AgentFactory.create_geometry_agent(
                global_override_model
            ),
            AgentType.ANIMATION: AgentFactory.create_animation_agent(
                global_override_model
            ),
            AgentType.CAPTION: AgentFactory.create_caption_agent(global_override_model),
            AgentType.AGGREGATOR: AgentFactory.create_aggregator_agent(
                global_override_model
            ),
